...
fun GreetingText(message: String,from: String,modifier: Modifier = Modifier){
    Column(
        ...
        Text(
            ...
            fontSize = 100.sp,
            lineHeight = 116.sp,
            textAlign = TextAlign.Center //alignement du contenu à l'intérieur du texte lui-même
        )
        Text(
            text = from,
            fontSize = 36.sp,
            modifier = Modifier
                .padding(16.dp)
                .align(alignment = Alignment.End) //centré globalement dans la Column
        )
    }
}
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        //GreetingText(message = "Happy Birthday Sam!", from = "From Samia")
        GreetingImage(
            message = "Happy Birthday Sam!",
            from = "From Samia"
        )
